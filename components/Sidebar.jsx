        ...
        <div className="lg:hidden fixed inset-0 z-[300] flex">
          ...
          <div className="relative z-10 w-64 bg-[#5C5470] h-full flex flex-col shadow-xl">
            <div className="p-5 flex flex-col items-center border-b border-white/10">
              <button
                onClick={() => setIsOpen(false)}
                className="self-end text-white/70 hover:text-white mb-2"
              >
                <FaTimes size={18} />
              </button>
...
export default function Sidebar() {
  ...
  return (
    <>
      {/* Fixed desktop sidebar - stays stable while page scrolls */}
      <div className="hidden lg:flex fixed left-0 top-0 w-64 h-screen bg-[#5C5470] flex-col shadow-[4px_0_24px_rgba(0,0,0,0.1)] z-[100] rounded-r-xl overflow-y-auto">
      ...
      {/* Spacer for desktop layout so content does not go under fixed sidebar */}
